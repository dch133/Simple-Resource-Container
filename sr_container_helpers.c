...
int setup_child_capabilities()
{
     ...
     *  Capabilities to disable: CAP_AUDIT_CONTROL, CAP_AUDIT_READ, CAP_AUDIT_WRITE, 
    ...
    // STEP (2) Now from the above caps clear our capabilities from the INHERITABLE set
...
int setup_syscall_filters()
{
    ...
    /* Load the created context into the kernel and release it from the current process memory */ 
